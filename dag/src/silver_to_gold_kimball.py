...
def silver_to_gold_kimball_dag():
    @asset
    ...
    @asset(outlets=[gold_kimball_dataset])
    def spark_transform_gold(config: Dict[str, Any]):
        """Submits the Silver to Gold Spark job."""
