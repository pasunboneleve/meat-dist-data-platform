# TODO: Create external Iceberg table after first Spark job populates gs://${google_storage_bucket.silver.name}/carcasses
# (BigQuery validates source_uris/files exist at creation time)
#
